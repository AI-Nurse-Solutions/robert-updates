...
window.SEED_GARDEN = [
  {
    ...
    next: "Run Phase 0 before building anything: metric definitions, the adversarial refusal-test bundle, consent language, and the synthetic scenario corpus. The gate is that every refusal class has a test that fails against a deliberately weakened prompt. Page publishes when PR #105 merges to main.",
  ...
  },
  {
    ...
    title: "Find a mission-aligned co-founder for personal AGI for nurses",
  ...
  {
    id: "capital-doctrine",
    title: "Codify a mission-preserving capital strategy",
    summary: "Organic growth remains the default while selective outside capital may be useful for bounded projects. The key question is what capital may accelerate without gaining authority over the mission.",
    status: "germinating", priority: "Medium", horizon: "This quarter", workstream: "Network / Capital",
    tags: ["VC", "Bootstrapping", "Mission", "Governance"],
    next: "Draft an own / partner / fund matrix for the ecosystem and define non-negotiable investor protections before any fundraising conversation."
  },
  {
    id: "sutter-hackathon-workflow",
    title: "Sutter Hackathon: prove one complete workflow end to end",
  ...
  },
  {
    ...
    title: "Keep a second hackathon workflow as a controlled option",
    summary: "A second workflow can demonstrate breadth, but only after the primary workflow is complete, testable, and defensible.",
    status: "seed", priority: "Medium", horizon: "Aug 27", workstream: "VNC ICU / Hackathon",
    tags: ["Scope control", "Prototype", "Workflow"],
    next: "Select only after workflow #1 reaches demo-ready status; otherwise preserve it as the next iteration."
  },
  {
    id: "beautiful-flight-hermes",
    title: "A Beautiful Flight: demonstrate Hermes skills as capability, not spectacle",
  ...
  },
  {
    ...
    title: "Personal AI as a mirror of values rather than a flattening intelligence",
    summary: "Personal intelligence should preserve pluralism: different people, professions, cultures, and communities can shape different intelligences while sharing common safety and human-rights boundaries.",
    status: "seed", priority: "High", horizon: "Long arc", workstream: "EDENA / Future Vision",
    tags: ["Pluralism", "Values", "Personal AI", "Human flourishing"],
    next: "Turn this into a doctrine note distinguishing universal guardrails from personal value configuration and professional stewardship."
  },
  {
    id: "global-nurse-seeding",
    title: "Seed Nurse Intelligence Network through nurse-source countries",
  ...
  },
  {
    ...
    title: "Make conversations a formal seed-capture mechanism",
    summary: "Useful musings should not disappear into chat history. Capture the signal first, then classify it by workstream, growth stage, priority, next action, and evidence produced.",
    status: "growing", priority: "High", horizon: "Now", workstream: "Personal Operating System",
    tags: ["Kanban", "Tacit knowledge", "Decision log", "Reflection"],
    next: "Use this board as the default destination for substantive new ideas and promote cards only when there is evidence of movement."
  },
  {
    id: "seed-to-evidence-loop",
    title: "Connect every project to an evidence loop",
  ...
  },
  {
    ...
    title: "Use free Nurse AI OS access as an install-base engine",
  ...
  },
  {
    ...
    title: "Nurses as the natural stewardship layer for personal and institutional AI",
  ...
  {
    id: "xprize-submitted",
    title: "EDENA future-vision film submitted to XPRIZE",
    summary: "Submission completed. The strategic harvest is the articulated future: personal AI reflects human values, diversity of intelligence is preserved, and nurses model stewardship rather than surrendering human authority to technology.",
  ...
  },
  {
    ...
    title: "Joined a San Francisco / New York founders network",
    summary: "A new discovery channel now exists for co-founders, startup pattern recognition, partnerships, and selective capital relationships.",
    status: "harvested", priority: "Medium", horizon: "Completed", workstream: "Network / Capital",
    tags: ["Milestone", "Founders", "Network"],
    next: "Convert membership into a deliberate relationship pipeline rather than passive group participation."
  },
  {
    id: "hackathon-paper-recognition",
    title: "Hackathon submission recognized as strongest paper so far",
    summary: "The initial concept has external validation from the hackathon preparation process. The next challenge is translating a strong paper into a demonstrable, measurable workflow.",
    status: "harvested", priority: "High", horizon: "Completed", workstream: "VNC ICU / Hackathon",
    tags: ["Milestone", "Validation", "Team"],
    next: "Use the recognition as confidence, not as proof; let the working demo and evaluation become the evidence."
  },
  {
    id: "beautiful-flight-maiden",
    title: "A Beautiful Flight maiden broadcast completed",
    summary: "The weekly broadcast now exists as a recurring public learning surface for Nurse AI OS and the emerging nurse-governed personal intelligence category.",
    status: "harvested", priority: "Medium", horizon: "Completed", workstream: "A Beautiful Flight",
    tags: ["Milestone", "Webinar", "Community"],
